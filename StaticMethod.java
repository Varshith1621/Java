class Mobile {
    ...
    public void show(){
        System.err.println("Using static Variable:");
        System.err.println("Brand:" + brand + " Price:" + price + " Network:" + network + " Name:" + name);
    }

    public static void show1(Mobile obj){ //static method
        System.err.println("Brand:" + obj.brand + " Price:" + obj.price + " Network:" + network + " Name:" + obj.name);
    }
}
...
public class StaticMethod {
    public static void main(String[] args) {
        ...
        System.err.println("Using static method:");
        Mobile.show1(obj1); //static method should be accessed by class name 
        //static method can access static variable directly and non-static variable by object reference
        Mobile.show1(obj2);
    }
    }